...
namespace lab05
{
    ...
    public class Controller
    {
        ...
        {
            var stream = new StreamReader(@"C:\Users\HP\Флешка\ООП\1 СЕМЕСТР\lab05\lab04\lab04\lab04\data.txt");
        ...
        class Program
        {
            private static void Main(string[] args)
            {
                ...
                var thirdMammal = new Mammals("Слон", 2014, 12000, 3);
                var zoo = new Zoo(firstBird, secondBird,
                    firstFish, secondFish,
                    firstMammal, secondMammal);
                zoo.PrintAnimalList();
                zoo.Add(thirdBird);
